...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li>
                <a href="{{ route('admin.dashboard') }}"><i class="fa fa-fw fa-home"></i>
                    Dashboard</a>
            </li>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form id="form">
                    ...
                    <div class="col-md-12">
                    <div class="form-group col-md-4 pad_left">
                        <label for="txtModelName">Model Name<span class="required">*</span></label>
                        <input type="text" class="form-control text-capitalize" name="model_name" required id="txtModelName" placeholder="Enter name">
                    </div>
                    ...
                    <div class="form-group col-md-4 pad_right">
                    ...
                    {{--<div class="col-md-12">
                        ...
                        <div class="form-group col-md-11 margtop">
                            <label class="alert alert-warning text-warning">The Primary key <span class="badge">( id )</span> and Timestamps <span class="badge">( created_at and updated_at )</span> will be created automatically for you table.</label>
                        </div>
                    </div>--}}
                    <div class="col-md-12">
                    ...
                    <div class="form-inline col-md-12" style="padding-top: 10px">
                        <div class="form-group chk-align" style="border-color: transparent;">
                            <button type="button" class="btn btn-success btn-flat" id="btnAdd"> Add Field
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="form-inline col-md-12 div_gnr_rst">
                        <div class="form-group btn_generate">
                            <button type="submit" class="btn btn-primary btn-flat" id="btnGenerate">Generate
                            </button>
                        </div>
                        <div class="form-group btn_generate">
